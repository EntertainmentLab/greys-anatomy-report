...
function StudyOverview() {
  ...
  return (
    <section className="report-section">
      ...
      <p>
        Television medical dramas have long reflected the realities of our everyday lives. As the climate crisis drives more extreme weather events that threaten public health and strain our healthcare systems, these shows – where medicine, science, and human emotion converge – may offer more than compelling stories. Could they help audiences see weather not as a trivial, abstract issue, but as a pressing, personal one? And could they deliver potentially life-saving information and inspire support for critical solutions in a warming world?
      </p>
      <p>
      ...
      <p>In addition to evaluating the episode on its own, the study also examined a <b>multiplatform condition</b>, which assessed the combined impact of the episode and a complementary social media campaign. Half of the viewers who watched the heat wave episode were then randomly assigned to watch one of four short-form videos immediately after the episode. Produced independently by an environmental organization, these social media videos explicitly linked the episode’s events to climate science and included calls to action for health system resilience.</p>
      <p>The strongest and most lasting effects were observed among viewers who saw both the heat wave episode and the follow-up social media videos. Additionally, this combined condition boosted:</p>
      <ul>
        <li className="definition-item">
      ...
      <p>Notably, through a series of interviews, we found that these gains came without sacrificing entertainment value.</p> <p><b>Viewers:</b></p>
      <ul>
        <li className="definition-item"><b>Connected the on-screen heat wave to their personal experiences with extreme heat</b> and its serious health impacts within their own families.</li>
      ...
      <p>It is important to acknowledge the areas where attitudes remained unchanged. The episode alone did not move most measures related to climate change broadly, like the perceived personal impacts of <b>climate change</b> (as opposed to the impacts of <b>severe heat waves</b>). This lack of movement is perhaps unsurprising, given that the episode did not explicitly reference climate change and the larger issue may not have been top-of-mind for viewers. Additionally, we did not find any significant effects on the perceived responsibility of healthcare workers’ to raise awareness about heat-related health risks.</p>
      ...
      <p> <b>As the climate crisis deepens, integrating accurate, emotionally-resonant stories into popular film, TV, and social media may be one of the most impactful tools for life-saving public awareness and action.</b> In fact, audiences agree…</p>
