...
function KeyFindings() {
  return (
    <section className="report-section">
      ...
      <p>In our interviews, one viewer found that the episode helped her understand that individuals "prone to heart problems" require more "heat protection" during hot weather. Only after viewing the episode did she fully connect how extreme heat could produce severe health consequences like "heart attacks, organ failure... all of these things."</p>
      ...
      <p>However, this effect was not sustained in the multiplatform condition. While Republican viewers in the combined multiplatform group initially showed a similar boost, those gains faded by the two-week follow-up – and in some cases, support dropped below baseline. This suggests that the explicit framing provided in the supplemental videos may have inadvertently triggered resistance or disengagement. While anecdotal, interviews with some Republican viewers suggested that the specific use of the phrase "climate change" in at least one of the social media videos was perceived as unwelcomed or polarizing. One interviewee, a self-identified conservative, said "the moment that she [the content creator in the social media video] said, quote climate change end quote...I instantly almost discard it as being a political message." He elaborated that "climate change has become sadly too political... it's been so muddied by politics that people aren't hearing each other anymore." He felt the inclusion of "climate change" in a statement is "instantly assigning blame to the occurrences" and causes the conversation to go "in a whole different direction." Meanwhile, he felt the episode (which again, does not use the term "climate change") maintained a "balance of entertainment and message." He was "entirely entertained" and "wasn't focused on 'Hey, there's a message being given to me here,' which is a good thing."</p>
      ...
      <PolicySupportChart />
      <p>Different audiences require different approaches – especially when designing supplemental or impact-driven social media content. While Democratic viewers may have needed explicit climate change and health connections to boost policy support, Republican viewers were moved by emotionally grounded, human-centered storytelling. These findings highlight the limitations of one-size-fits-all strategies, but they also underscore the unique potential of audience-tailored messaging in strategic, multiplatform media campaigns that bring together film and TV with social media. </p>
