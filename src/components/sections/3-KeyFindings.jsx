...
function KeyFindings() {
  return (
    <section className="report-section">
      ...
      <p>Another, inspired by the episode, said that she would "call my family, making sure I check in on them, and when it's super hot outside, and tell them to look out for the different health risks that are being discussed [in the episode]."</p>
      <AMEChart1 />
