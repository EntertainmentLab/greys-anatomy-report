...
function KeyFindings() {
  return (
    <section className="report-section">
      ...
      <p>In our survey, we asked viewers: “<em>How likely is it that you, your family, or your community will be seriously impacted by at least one severe heat wave this summer?</em>”</p>
      ...
      <p>Our one-on-one interviews confirmed how viewing the heat wave episode can influence perception of heat wave likelihood. One viewer remarked, “<em>Wow…This is going to be more common, you know, every single year… There are going to be more heat waves in places that are not prepared or not used to heat waves.</em>”</p>
      ...
      <p>One interviewee remarked that the episode was “<em>a reminder to me how serious the heat is, and how it is deadly, and to not underestimate it, to be prepared....</em>” She further elaborated, “<em>It makes you realize... ‘I could very well be in that situation, and I shouldn’t play around with it and always be prepared.’</em>”</p>
      ...
      <p>These findings highlight the limitations of one-size-fits-all strategies, but they also underscore the unique potential of audience-tailored messaging in strategic, multiplatform media campaigns that bring together film and TV with social media.</p>
